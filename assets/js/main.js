/* ===================================================================
   Advocacia Odontológica — Denis Carvalho Advocacia
...
(function () {
  ...
  /* === Configurações === */
  var WA_NUMBER = "5562992565904"; // WhatsApp (62) 99258-6422

  // E-book entregue ao preencher o formulário lateral
  var EBOOK_URL  = "assets/ebooks/guia-juridico-do-dentista.pdf";
  var EBOOK_NOME = "Guia Jurídico do Cirurgião-Dentista";
    ...
    try {
      fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: "Novo lead do e-book — Advocacia Odontológica",
          from_name: "Site Advocacia Odontológica",
          nome: nome,
          email: email,
